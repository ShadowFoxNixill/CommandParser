...
public class MessageSender {
  ...
  /**
   * Attempts to send multiple messages to a channel.
   * @param chan The channel to which the messages should be sent.
   ...
   * @param chan The channel to which the EmbedObjects should be sent.
   * @param msgs The EmbedObjects to send.
   */
   ...
   * Attempts to edit an existing message.
   * @param msg The message to update.
   * @param out The new {@link EmbedObject}.
   * @return A {@link RequestFuture} that will eventually hold the new message.
   */
  ...
  public static void delete(IMessage msg) {
    RequestBuffer.request(() -> {
      IUser us = CommandReader.getClient().getOurUser();
      if (msg != null) {
   ...
   * @param msg The message to which to react.
   * @param emo The emoji with which to react.
   */
